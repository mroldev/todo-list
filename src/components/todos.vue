    ...
    <div>
        <section class="todoapp">
            ...
            <div class="main">
                ...
                <ul class="todo-list">
                    <li class="todo" v-for="todo in  filtersTodos" :key="todo" :class="{completed: todo.completed, editing: todo=== editing}" >
                        <div class="view">
                ...
                <footer class="footer" v-show="hasTodos">
                        ...
                        <ul class="filters">
                            <li><a href="#" :class="{selected : filter === 'all'}" @click.prevent="filter ='all'">tout</a></li>
                            <li><a href="#" :class="{selected : filter === 'todo'}" @click.prevent="filter ='todo'">A faire</a></li>
                            <li><a href="#" :class="{selected : filter === 'done'}" @click.prevent="filter ='done'">Faites</a></li>
                        </ul>

                        <button class="clear-completed" v-show="completed" @click.prevent="deleteCompleted">Supprimer les taches termine</button>
